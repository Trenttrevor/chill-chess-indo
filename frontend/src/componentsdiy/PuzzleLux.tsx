...
const PuzzleLux = () => {
  ...
  // 2. Replace your showHint function:
  const showHint = () => {
              ...
              {status === "wrong" && (
                <div className="plx-overlay plx-ov-wrong">
                  ...
                  <div className="plx-ov-btns">
                    ...
                    <button className="plx-btn" onClick={() => showHint()}>
                      Hint
                    </button>
                  </div>
                </div>
          ...
          >
            <div
              ...
              style={{
                ...
                minWidth: "300px",
                boxShadow:
                  "0 0 60px rgba(212,175,55,0.08), 0 30px 60px rgba(0,0,0,0.8)",
                textAlign: "center",
                animation: "hintIn 0.25s cubic-bezier(0.16,1,0.3,1)",
              }}
            >
              {/* Crown icon */}
              <div
